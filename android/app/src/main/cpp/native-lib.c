...
Java_com_digitalstorm_ciadpi_ByeDpiProxy_jniStartProxy(JNIEnv *env, __attribute__((unused)) jobject thiz, jobjectArray args) {
    if (g_proxy_running) {
...
JNIEXPORT jint JNICALL
Java_com_digitalstorm_ciadpi_ByeDpiProxy_jniStopProxy(__attribute__((unused)) JNIEnv *env, __attribute__((unused)) jobject thiz) {
...
JNIEXPORT jint JNICALL
Java_com_digitalstorm_ciadpi_ByeDpiProxy_jniForceClose(__attribute__((unused)) JNIEnv *env, __attribute__((unused)) jobject thiz) {
